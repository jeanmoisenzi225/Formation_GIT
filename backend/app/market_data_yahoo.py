"""Market data access via yfinance — used as a fallback for tickers that
aren't BRVM-listed (e.g. a portfolio holding a handful of international
stocks alongside its BRVM core).
